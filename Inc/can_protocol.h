...
enum ExtCmd {Ext_Heartbeat, ExtResponse, Ext_GetModuleData, Ext_DOState, Ext_DOWrite, Ext_AIState, ExtByteWrite};
...
#define CAN_EXT_HEADER_LENGTH	4		// addr, packet signature, num of subpacket (4 bits) and quantity of packets (4 bits), cmd
